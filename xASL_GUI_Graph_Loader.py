...
# from xASL_GUI_Graph_CentralWidget import xASL_PostProc
import pandas as pd
import os
...
class xASL_GUI_Data_Loader:
    ...
    def load_exploreasl_data(self):
        ...
        if os.path.exists(os.path.join(self.parent_cw.le_analysis_dir.text(), "Population", "Stats")):
            ...
            self.parent_cw.cmb_figuretypeselection.setEnabled(True)  # Data is loaded; figure selection settings can be enabled
